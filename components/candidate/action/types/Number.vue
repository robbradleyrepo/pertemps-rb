...
@Component
export default class NumberAction extends Mixins(ActionBase) {
  @Prop({ required: true, type: Object as () => Action.Number })
  readonly data!: Action.Number;

  value?: Action.InputValue.Number;
}
</script>
